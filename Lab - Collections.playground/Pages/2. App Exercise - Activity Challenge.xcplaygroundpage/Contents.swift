 ...
 */
var walkChallenges: [String] = ["Walk 3 miles a day", "Walk around the park once"]
var runChallenges: [String] = ["Run 5 times a week.", "Run 4 miles a day"]
...
if newChallenges.contains("running") {
